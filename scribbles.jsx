...
const AutoRickshaw = ({ className, style }) => (
  <img
    src="assets/auto-rickshaw-maroon.png"
    alt=""
    aria-hidden="true"
...
const GrumpyWord = ({ children, className = "" }) => (
  <span className={"grumpy-word " + className}>
    ...
    <img className="gw-face" src="assets/grumpy-mascot-rust.png" alt="" aria-hidden="true" />
...
const MarchingMascot = () => (
  <div className="marching-mascot" aria-hidden="true">
    <img src="assets/grumpy-mascot-cream.png" alt="" />
  </div>
);
