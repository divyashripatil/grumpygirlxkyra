  ...
  <section id="mission" className="manifesto" data-screen-label="02 Manifesto">
    <div className="wrap">
      <div>
        ...
        <img src="assets/grumpy-mascot-cream.png" alt="" aria-hidden="true" className="manifesto-mascot" />
      </div>
      <div>
        <p>
...
const PolaroidCarousel = () => {
  const photos = [
    "assets/photo-waffle.jpg",
    "assets/photo-coffee.jpg",
...
const Activities = () => (
  <section id="activities" className="section activities" data-screen-label="05 Activities">
    <div className="wrap">
      ...
      <img src="assets/grumpy-mascot.png" alt="" aria-hidden="true" className="activities-grumpy" />
...
const Approval = ({ formRef, food, setFood, drink, setDrink }) => (
  <section id="apply" className="section approval" data-screen-label="08 Apply" ref={formRef}>
    ...
    <img src="assets/grumpy-mascot.png" alt="" aria-hidden="true" className="approval-face" />
  </section>
);
